...
type RegisterRequest struct {
	...
	Password    string `json:"password" binding:"required,min=8,max=72,containsany=!@#$%^&*,containsany=0123456789,containsany=ABCDEFGHIJKLMNOPQRSTUVWXYZ"`
...
type ChangePasswordRequest struct {
	...
	NewPassword string `json:"newPassword" binding:"required,min=8,max=72,containsany=!@#$%^&*,containsany=0123456789,containsany=ABCDEFGHIJKLMNOPQRSTUVWXYZ"`
}
